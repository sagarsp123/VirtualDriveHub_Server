        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  ...
                  <input
                    ...
                    id="email"
                    value={listing.email}
                    onChange={(e)=>setListing(prev=>{return {...prev,"email":e.target.value}})}
                    autoComplete="email"
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about the Car.</p>
            </div>

            <div className="col-span-full w">
              <label htmlFor="photo" className="block text-sm font-medium leading-6 text-gray-900">
                Photo URL
              </label>
              <div className="mt-2 w-3/12 flex items-center gap-x-3">
